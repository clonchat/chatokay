...
export default function ComercialSubscriptionsPage() {
  const subscriptions = useQuery(api.subscriptions.listMyReferredSubscriptions);
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-slate-600 dark:text-slate-400 mt-2">
          Suscripciones de tus clientes referidos
        </p>
      </div>
